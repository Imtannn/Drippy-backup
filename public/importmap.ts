{
	...
	const lumeVersion = '0.3.0-alpha.46'
	...
	const importmap = {
		imports: {
			...
			'@lume/element':
				'https://cdn.jsdelivr.net/gh/lume/element@195a642ac89d21d172d953f83a3e2d2a2625a77a/dist/index.js',
	...
	// Load the loading icon module as soon as possible so that we have a loading
	// experience as soon as possible before loading anything else.
	document.write(html` <link rel="modulepreload" href="${importmap.imports['lume/']}dist/examples/LoadingIcon.js" /> `)
}
